...
| 2 | header switch | **Provider** | "Separate workspaces. One identity. Switch to Client to browse and buy." |
...
```text
apps/web            Next.js UI + 5 API routes (services, access-passes, grants, bot, gateway)
