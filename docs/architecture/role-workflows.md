...
| --- | --- | --- |
| Identity | Sign in with Swarm ID (`buyer_id`, pass key, sharing key for private files); connect a browser wallet (MetaMask, Rabby, Core) to pay | Sign in with Swarm ID; derive the payout wallet |
