...
Config: `NEXT_PUBLIC_ENS_CHAIN` = `sepolia` (default; ENSv2 beta, names at https://app.ens.dev, resolved through UniversalResolverV2) or `mainnet`; optional `NEXT_PUBLIC_ENS_RPC_URL` / `ENS_RPC_URL`.
